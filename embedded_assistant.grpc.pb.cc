...
EmbeddedAssistant::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  : channel_(channel), rpcmethod_Converse_(EmbeddedAssistant_method_names[0], ::grpc::RpcMethod::BIDI_STREAMING, channel)
  {}
...
::grpc::ClientReaderWriter< ::google::assistant::embedded::v1alpha1::ConverseRequest, ::google::assistant::embedded::v1alpha1::ConverseResponse>* EmbeddedAssistant::Stub::ConverseRaw(::grpc::ClientContext* context) {
  return new ::grpc::ClientReaderWriter< ::google::assistant::embedded::v1alpha1::ConverseRequest, ::google::assistant::embedded::v1alpha1::ConverseResponse>(channel_.get(), rpcmethod_Converse_, context);
}
...
::grpc::ClientAsyncReaderWriter< ::google::assistant::embedded::v1alpha1::ConverseRequest, ::google::assistant::embedded::v1alpha1::ConverseResponse>* EmbeddedAssistant::Stub::AsyncConverseRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::ClientAsyncReaderWriter< ::google::assistant::embedded::v1alpha1::ConverseRequest, ::google::assistant::embedded::v1alpha1::ConverseResponse>::Create(channel_.get(), cq, rpcmethod_Converse_, context, tag);
}
...
EmbeddedAssistant::Service::Service() {
  AddMethod(new ::grpc::RpcServiceMethod(
      ...
      new ::grpc::BidiStreamingHandler< EmbeddedAssistant::Service, ::google::assistant::embedded::v1alpha1::ConverseRequest, ::google::assistant::embedded::v1alpha1::ConverseResponse>(
